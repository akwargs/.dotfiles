...
if s:configuration.transparent_background
  ...
  call s:HL('SignColumn', s:palette.fg, s:palette.bg5)
endif
...
call s:HL('CursorColumn', s:palette.none, s:palette.bg5)
...
call s:HL('Pmenu', s:palette.fg, s:palette.bg5)
